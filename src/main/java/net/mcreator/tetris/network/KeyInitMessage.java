...
import net.mcreator.tetris.procedures.EProcedure;
...
public class KeyInitMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		TetrisMod.addNetworkMessage(KeyInitMessage.class, KeyInitMessage::buffer, KeyInitMessage::new, KeyInitMessage::handler);
	}
}
