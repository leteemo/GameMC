...
public class KeyActivateMessage {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			if (!entity.level.isClientSide()){
				ClavierProcedure.goTo(ClavierProcedure.highestBlock(), true);
			}
		}
		if (type == 1) {
		}
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		TestMod.addNetworkMessage(KeyActivateMessage.class, KeyActivateMessage::buffer, KeyActivateMessage::new, KeyActivateMessage::handler);
	}
}
